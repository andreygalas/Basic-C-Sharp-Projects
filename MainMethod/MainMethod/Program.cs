...
namespace MainMethodassign
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Your integer plus 10 is: " + myOp.Mathop(userNum));
            ...
            Console.WriteLine("Your decimal multiplied by 15 is: " + myOp2.Mathop(userNumFloat));
            ...
            Console.WriteLine("Your integer divided by 4 is: " + myOp3.Mathop(Console.ReadLine()));
            Console.ReadLine();
        }
    }
}
